 ...
 var movement = setInterval(() => {
     if (pausa === 0) {
         ...
         if ((posicionTP[0].ancho == manzanaTP[0]) && (posicionTP[0].alto == manzanaTP[1])) { 
             //the logic is similar to ./movement.js, with the difference that there are two apples, and when the snake goes over one of them it changes the position of the head to the opposite

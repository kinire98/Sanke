    ...
    var movement = setInterval(() => {
        if (pausa === 0) {
            ...
            if ((posicionPaz[0].ancho == manzanaPaz[0]) && (posicionPaz[0].alto == manzanaPaz[1])) { 
                ...
                //The logic is the same that the one from ./movement.js, with the exception that where it checks if you surpassed one of the edges of the box, it tests by which edge it was and it move to the opposite site
